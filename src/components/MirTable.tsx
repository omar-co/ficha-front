...
function OdsTable() {
    ...
    const base = process.env.REACT_APP_API_URL + '/admin/mir';
    const initial: any = [];
    ...
    const loadData = async () => {
        await axios.get(process.env.REACT_APP_API_URL + '/admin/filtro/mir', {headers: authHeader()}).then(function (response) {
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <button type="button" className="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                        <h4 className="modal-title" id="myModalLabel">Importar objetivos MIR</h4>
                    </div>
                    <div className="modal-body">
                        <div className="row">
